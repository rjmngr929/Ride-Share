...
class AppUtils private constructor() {
    ...
    fun getAppLauncherActivity(@NonNull context: Context): String {
        ...
        val activityList = intent?.let { context.packageManager.queryIntentActivities(it, 0) }
        return activityList?.get(0)?.activityInfo?.name ?: "Not Found"
    }
    ...
    fun sendSMS(
        ...
        try {
            ...
            AlertDialogUtility(mContext).showAlert(mContext, null, "আপনার জরুরী ম্যাসেজটি পাঠানো হয়েছে।")
        } catch (ex: Exception) {
